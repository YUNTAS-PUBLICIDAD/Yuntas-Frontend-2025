...
function buildWhatsappUrl(phone: string, message: string) {
  ...
  return `https://wa.me/${digits}?text=${encodeURIComponent(message || 'Hola, me gustaría obtener más información.')}`;
}
          ...
          <div className="relative overflow-hidden bg-gradient-to-b from-[#04194c] via-[#0a2f6f] to-[#2398ab] px-4 py-8 text-white min-h-96">
            ...
            {whatsappUrl && (
              <div
                role="presentation"
                aria-hidden="true"
                className="mt-8 inline-flex w-full cursor-default items-center justify-center gap-3 rounded-xl bg-[#62c08f] px-5 py-3.5 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(98,192,143,0.22)]"
              >
            ...
            <div className="mt-8 flex items-center gap-4">
              <div className={`inline-flex h-10 w-10 items-center justify-center rounded-full transition-opacity ${
                config.redes.instagram ? 'bg-[#031733] text-white' : 'bg-[#031733]/30 text-white/30'
              }`}>
                <InstagramIcon className="h-5 w-5" />
              </div>
              <div className={`inline-flex h-10 w-10 items-center justify-center rounded-full transition-opacity ${
                config.redes.facebook ? 'bg-[#031733] text-white' : 'bg-[#031733]/30 text-white/30'
              }`}>
                <FacebookIcon className="h-5 w-5" />
              </div>
              <div className={`inline-flex h-10 w-10 items-center justify-center rounded-full transition-opacity ${
                config.redes.tiktok ? 'bg-[#031733] text-white' : 'bg-[#031733]/30 text-white/30'
              }`}>
                <TikTokIcon className="h-5 w-5" />
              </div>
              <div className={`inline-flex h-10 w-10 items-center justify-center rounded-full transition-opacity ${
                config.redes.youtube ? 'bg-[#031733] text-white' : 'bg-[#031733]/30 text-white/30'
              }`}>
