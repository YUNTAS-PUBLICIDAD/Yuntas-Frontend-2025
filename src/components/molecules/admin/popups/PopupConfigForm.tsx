...
export default function PopupConfigForm({ initialData, onSubmit, onCancel, isSaving, pageTarget }: PopupConfigFormProps) {
  ...
  <div className="lg:col-span-7 bg-white dark:bg-[#191F44] p-4 md:p-6 rounded-xl shadow-sm border border-gray-100 dark:border-white/20 max-h-[75vh] overflow-y-auto">
        <div className="flex flex-col gap-6">

          {/* ESTADO */}
          <div className="flex items-center justify-between bg-gray-50 dark:bg-[#1C2347] p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              className={`${active ? 'bg-[#6DE1E3]' : 'bg-gray-300 dark:bg-gray-600'} relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-[#FFFFFF] transition-colors duration-200 ease-in-out focus:outline-none`}
            >
...

          {
            ...
            //     setProductId( value ? Number(e.target.value) : null)}} disabled={!active} className='w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-[#FFFFFF] dark:bg-[#282E50] dark:text-white outline' name="" id="">
          ...
          <div className={`flex flex-col gap-4 ${!active ? 'opacity-50' : ''}`}>
            <div className="bg-gray-50 dark:bg-[#1C2347] p-4 rounded-lg border border-gray-200 dark:border-gray-700 flex flex-col gap-4 ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select value={delaySeconds} onChange={(e) => setDelaySeconds(e.target.value)} disabled={!active} className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-[#FFFFFF] dark:bg-[#282E50] dark:text-white outline-none focus:border-blue-500 disabled:cursor-not-allowed">
            ...
            <div className={`flex flex-col gap-4 ${!active ? 'opacity-50' : ''}`}>
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  disabled={!active}
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-[#FFFFFF] dark:bg-[#282E50] dark:text-white outline-none focus:border-blue-500 disabled:cursor-not-allowed placeholder-gray-400"
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className='flex flex-col gap-1'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    }} disabled={!active} className='h-10 w-14 cursor-pointer rounded border border-gray-300 dark:bg-[#203565] dark:border-gray-600 p-1' value={buttonTextColor} />
...

          {
            pageTarget !== "product-detail" && (
              ...
              <div className={`bg-gray-50 dark:bg-[#1C2347] p-4 rounded-lg border border-gray-200 dark:border-gray-700 flex flex-col gap-4 ${!active ? 'opacity-50' : ''}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-b dark:border-gray-600 pb-4 mt-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      disabled={!active}
                      className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#282E50] dark:text-white outline-none focus:border-blue-500 placeholder-gray-400"
                    />
      ...
      <div className="lg:col-span-5 bg-gray-100 dark:bg-[#1C2347] p-6 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 flex flex-col items-center min-h-[500px] relative overflow-hidden">
