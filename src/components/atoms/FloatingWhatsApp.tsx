  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      <Link
        ...
        className="relative flex items-center justify-center w-20 h-20 bg-[#25D366] rounded-full shadow-2xl hover:bg-[#20bd5a] transition-colors duration-300 animate-heartbeat"
