...
const HeroSearchSection = ({ listaProductos, setListaProductos, allProductos }:HeroSearchSectionProps) => {
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 items-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-6 md:py-10 gap-6 md:gap-4 place-items-center md:place-items-start'>
        ...
        <SearchBar listaProductos={listaProductos} allProducts={allProductos} setListaProductos={setListaProductos} />
    </section>
  )
}
