...
// Icono de Ojo 
const EyeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#006D77" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const CustomInfoCard = ({ text, icon: Icon }: { text: string; icon: any }) => {
  return (
    <div className="flex items-center w-full max-w-3xl">
      {/* Círculo del icono */}
      <div className="flex-shrink-0 relative z-10 bg-[#B2EBF2] w-24 h-24 rounded-full flex items-center justify-center shadow-md">
        <Icon />
      </div>
      
      {/* Texto */}
      <div className="bg-[#E0F7FA] -ml-8 pl-10 pr-8 py-4 rounded-r-full rounded-l-none flex-grow h-20 flex items-center">
        <p className="text-gray-800 font-semibold text-base md:text-lg leading-tight">
          {text}
        </p>
      </div>
    </div>
