			...
			<div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
				<div className="flex items-center gap-4 mb-10 md:mb-14">
					...
					<div>
						...
						<Text variant="h2" color="text-brand-blue" className="font-bold text-3xl md:text-4xl lg:text-5xl leading-tight">
							BENEFICIOS
						</Text>
					</div>
				</div>
					...
					<div className="flex-1 w-full order-2 lg:order-2">
						<div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-lg">
							<div className="mb-6 pb-4 border-b border-[#E2F6F6]">
								<span className="text-sm md:text-base uppercase tracking-[0.25em] text-brand-blue font-bold leading-snug block">
							...
							{productSlug && (
								<div className="pt-6 flex justify-start">
									<Link
										...
										className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#00031E] to-brand-blue text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl hover:shadow-xl transition-all duration-300 font-bold group text-sm md:text-base"
									>
