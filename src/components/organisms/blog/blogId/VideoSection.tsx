...
const VideoSection = ({ 
	...
	return (
		<section className='relative w-full py-6 md:py-10 bg-[#E2F6F6] overflow-hidden'>
			...
			<div className="absolute bottom-20 right-0 w-96 h-96 bg-brand-blue/6 rounded-full blur-3xl pointer-events-none translate-x-1/2" />
			...
			<div className='container mx-auto px-4 md:px-6 lg:px-8 relative z-10'>
				<div className="flex items-center gap-4 mb-6 md:mb-8">
					...
					<div>
						<Text variant="h2" color="text-brand-blue" className="font-bold">VIDEO DESTACADO</Text>
					</div>
				</div>
				...
				{(activeSubtitle || activeDescription) && (
					<div className='flex flex-col gap-4 mb-8 md:mb-12 text-center max-w-4xl mx-auto'>
						...
						{activeDescription && (
							<p className='text-brand-blue text-base md:text-lg leading-relaxed'>
								{activeDescription}
							</p>
						)}
					</div>
				...
				<div className='flex flex-col gap-8 items-center'>
					...
					<div className='flex flex-col gap-4 items-center'>
						<p className='text-center text-brand-blue text-base md:text-lg font-bold'>
