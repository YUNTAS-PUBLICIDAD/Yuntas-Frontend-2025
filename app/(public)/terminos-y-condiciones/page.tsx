        ...
        <main>
            ...
            <StaticContent bannerTitle="Términos y Condiciones">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-3xl font-bold text-[#203565]">TÉRMINOS Y CONDICIONES</h3>
                </div>
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">2. Aceptación de los términos</h4>
                    <p className="text-[#203565]">
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">3. Uso del sitio web</h4>
                    <p className="text-[#203565]">
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">4. Protección de datos personales</h4>
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">5. Propiedad intelectual</h4>
                    <p className="text-[#203565]">
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">6. Modificaciones</h4>
                    <p className="text-[#203565]">
                ...
                <section className="mb-8">
                    <h4 className="text-xl font-bold text-[#203565] mb-2">7. Legislación aplicable y jurisdicción</h4>
                    <p className="text-[#203565]">
